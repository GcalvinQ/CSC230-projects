...
class BookingAppEquipment(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'booking_app_equipment'


class BookingAppSchedule(models.Model):
...
class UserProfile(models.Model):
    staff = models.OneToOneField(AuthUser, models.DO_NOTHING, blank=True, null=True)
